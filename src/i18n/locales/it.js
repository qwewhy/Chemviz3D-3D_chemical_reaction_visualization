export default {
  translation: {
    ...
    home: {
      ...
      features: {
        simulation: {
          ...
          description: 'Sperimenta le reazioni chimiche in un ambiente 3D in tempo reale'
        },
        interaction: {
          title: 'Apprendimento interattivo',
          description: 'Interagisci con le molecole e osserva il loro comportamento'
        },
        learning: {
          title: 'Strumento educativo',
          description: 'Impara la chimica attraverso esperienze visive e interattive'
        }
      }
    },
    simulator: {
    ...
    molecules: {
      ...
      waterDesc: 'La molecola d\'acqua è una delle sostanze chimiche più fondamentali',
      categories: {
    ...
    about: {
      title: 'Chi siamo',
      description: 'Un sistema di visualizzazione 3D delle reazioni chimiche basato su Three.js e React',
      features: {
    ...
    footer: {
      ...
      description: 'Una piattaforma interattiva di visualizzazione 3D per le reazioni chimiche',
      quickLinks: {
        title: 'Link rapidi',
        about: 'Chi siamo',
        contact: 'Contatti',
